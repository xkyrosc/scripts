...
utils.smoothscrolling = 
    loadstring(game:HttpGet("https://raw.githubusercontent.com/lug1adev/ZyrtecHub/main/SmoothScroll.lua", true))()
...
do 
    ...
    local CreditTab = Window.createTab("ZyrtecHub V2 [Free]", true)

    CreditTab.createTabHeader("ZyrtecHub")
    ...
    local DD = CreditTab.createDropdown("ZyrtecHub Nigga", icon, false, s, 1, function(a)
        print(a)
    end)
    ...
    local LB = CreditTab.createLabel("ZyrtecHub Lug1a", icon)

    CreditTab.createButton("ZyrtecHub Negar", icon, function()
    ...
    local ADLB = ADT.createLabel("ZyrtecHub UWU", icon)

    ADT.createSlider("UWUZURE", icon, 0, 100, 50, function(a)
        print(a)
    end)

    ADT.createToggle("ZyrtecHub ZyrtecHub ZyrtecHub ZyrtecHub", icon, false, function(a)
        print(a)
        ADLB.Update(a)
    end)
